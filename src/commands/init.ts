...
function createYamlContract(path: string, featureName: string, owner: string): void {
...
function createTypeScriptContract(path: string, featureName: string, owner: string): void {
